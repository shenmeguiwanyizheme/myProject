package com.example.pojo.chargingpile;
...
public class ChargingPile {
    ...
    private BigInteger parkingPlaceId;
    ...
    private Integer updateTime = (int) (System.currentTimeMillis() / 1000);//Entity数据库实体的所有类型都跟数据库一样
